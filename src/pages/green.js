      ...
      <article className="post-content page-template no-image">
        <div className="post-content-body">
          ...
          <div>
            ...
            <p>
              Amsterdam Furniture Lab is een groot fan van hergebruik: van onze
              eigen meubels kunnen we altijd iets nieuws frezen omdat we meestal
              geen metalen verbinders gebruiken, maar ook met uw oude tafelblad
              bent u van harte welkom, als u bijvoorbeeld geen tafel meer nodig
              heeft, maar wel een bed.
            </p>
          </div>
        </div>
      </article>
