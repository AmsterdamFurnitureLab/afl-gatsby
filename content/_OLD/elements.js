...
const ElementsPage = ({ data }, location) => {
  ...
  return (
    <Layout title={siteTitle}>
      <SEO
        title="computergestuurde frees"
        keywords={[`amsterdam furniture lab`, `maatwerk`, `frees`, `cnc`]}
      />
      ...
      <article className="post-content page-template no-image">
        <div className="post-content-body">
          <p>
            ...
            . Finally, this is a <Link to="/elements">link</Link>.
          </p>
          ...
          <ul className="actions">
            <li>
              <Link to="/elements" className="button primary">
                Primary
              </Link>
            </li>
            <li>
          ...
          <ul className="actions">
            ...
            <li>
              <Link to="/elements" className="button small">
                Small
              </Link>
            </li>
          </ul>
          <ul className="actions fit">
            <li>
              <Link to="/elements" className="button primary fit">
                Fit
              </Link>
            </li>
            <li>
              <Link to="/elements" className="button fit">
                Fit
              </Link>
            </li>
          </ul>
          <ul className="actions fit small">
            <li>
              <Link to="/elements" className="button primary fit small">
                Fit + Small
              </Link>
            </li>
            <li>
              <Link to="/elements" className="button fit small">
                Fit + Small
              </Link>
            </li>
          </ul>
...
const indexQuery = graphql`
  query {
    ...
    smallPic: file(
      relativePath: { eq: "cncCloseUp.jpeg" }
    ) {
      childImageSharp {
        fluid(maxWidth: 1360) {
    ...
    medPic: file(relativePath: { eq: "cncCloseUp.jpeg" }) {
      childImageSharp {
        fluid(maxWidth: 1360) {
          ...GatsbyImageSharpFluid
        }
